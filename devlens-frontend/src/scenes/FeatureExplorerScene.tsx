    ...
    return (
        ...
        >
            ...
            <div className="absolute top-6 left-8 z-20 text-left pointer-events-none">
                <h1 className="text-emerald-100/90 text-xl font-extralight tracking-[0.4em] uppercase font-mono">
                    Drop2Life_OpenSource
                </h1>
                <p className="text-teal-100/40 text-[10px] tracking-[0.3em] uppercase mt-0.5 font-mono">
                    Feature Overview
                </p>
                <p className="text-emerald-50/65 text-xs mt-3 font-mono leading-relaxed max-w-[320px]">
                    Hover over any feature to learn more.
                    <br />
                    <span className="text-teal-300/80">Click the terminal button →</span> to start exploring a repository.
                </p>
            </div>
